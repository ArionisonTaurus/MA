%!TEX root = DieLoesungAllerMilleniumsprobleme.tex
    ...
    \begin{remark}
    	...
    	Wenn $a$ und $b$ unabhängig über $S$ sind und $a'$ und $b'$ unabhängig über $S'$, außerdem $\tp(b'/S)$ stationär, dann gilt, dass der gemeinsame Typ von $a$ und $b$ ebenso durch $\varphi$ übertragen werden kann: $$\varphi(\tp(a,b/S))=\tp(a',b'/A).$$
    \end{remark}
