%!TEX root = DieLoesungAllerMilleniumsprobleme.tex
    ...
    \begin{fact}\label{Eliminierungsregeln}
    	...
    	das man dann mit den vorigen Schritten weiter umwandeln kann.
    \end{fact}
    
    Es steht noch eine Erklärung der genauen Verwendung dieses Fakts aus:\\
