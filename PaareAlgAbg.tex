%!TEX root = DieLoesungAllerMilleniumsprobleme.tex
    ...
    \end{remark}
    \begin{remark}
    	Es reicht, die Erhaltung der linearen/algebraischen Unabhängigkeit nur für beliebige endliche Mengen zu prüfen, weil lineare/algebraische Unabhängigkeit einer Menge genau dann besteht, wenn sie für alle endlichen Teilmengen gilt.
    \end{remark}
    \begin{remark}
