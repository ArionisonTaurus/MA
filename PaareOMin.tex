...
\begin{lemma}
	Kleine Mengen in einem echten dichten Paar bilden ein Ideal in den\linebreak $\lingua^P$-definierbaren Mengen bzgl. $\glqq{}\subseteq\grqq{}$.
\end{lemma}
\begin{proof}
...
In diesem Kontext wird wieder die $\acl$-Unabhängigkeit in einem Modell von T relevant. Man kann sich dafür folgende Fakten überlegen. Dabei sind 1.-4. schon bekannt aus den Aussagen TODO
