...
\newpage
\begin{theorem}
	Sei eine $\lingua^P_S$-definierbare Menge $X\subseteq B$. Dann stimmt $X$ bis auf eine kleine $\lingua^P_S$-definierbare Menge mit einer $\lingua_S$-definierbaren Menge $X'$ überein.\colorbox{green}{Ende Korrektur der Formatierung}
\end{theorem}
\begin{proof}
