...
\begin{definition}
	Eine vollständige Theorie sei o-minimal, wenn ein Modell es ist.
\end{definition}

Ab jetzt geben wir uns ein o-minimales Modell $\fM$ so vor, dass die Ordnung dicht ist.
\begin{bemdef}
	Die endliche Folge $\sigma$ zur jeweiligen Zelle $Z$ ist eindeutig bestimmt und daher der Wert $\dim(Z)=\sum\limits_{i=1}^n\sigma(i)$ wohldefiniert. Er wird \textbf{Dimension der Zelle} genannt.
\end{bemdef}
