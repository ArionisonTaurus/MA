...
\begin{proof}
	...
	Für offene Zellen $Z$ ist so eine Darstellung also schon gefunden. Sei $Z$ nun eine Zelle der Dimension $d<m$ und $\pi:B^d\rightarrow B^m$ eine $\lingua_S$-definierbare Fortsetzung des kanonischen Homöomorphismus der entsprechenden offenen Zelle $Z'$ nach $Z$. Indem man mit Lemma \ref{Definierbare Mengen Spezialität} ein $\lingua_S$-definierbares $E\subseteq B^d$ findet mit $A^d\cap Z'\cap\pi^{-1}(A^m)=A^d\cap E$, erhält man 
	\begin{align*}
	g(Z\cap A^m)&=(g\circ\pi)(Z'\cap\pi^{-1}(A^m))\\&=(g\circ\pi)(A^d\cap Z'\cap\pi^{-1}(A^m))=(g\circ\pi)(A^d\cap E),
	\end{align*}
	wobei die mittlere Gleichheit gilt, da $A^d\supseteq Z'\cap\pi^{-1}(A^m)$, weil $\pi|_{Z'}$ die Umkehrabbildung einer Projektion ist.\\
	Die Gleichung ist dann aber schon der Fall eines kleineren $m$ und mit Induktion folgt die Aussage.
\end{proof}
