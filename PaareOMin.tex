...
\section{TODO: Noch woanders einsortieren}
\begin{lemma}
...
\begin{proof}
	...
	$$\bigcup\limits_{y'\in Y'\cap A^m}U_{\pi^{-1}(y')}=\bigcup\limits_{y\in\pi^{-1}(Y'\cap A^m)}U_y=\bigcup\limits_{y\in Y\cap A^n}U_y$$
	...
	\begin{lemma}
		Seien drei $\lingua$-definierbare Mengen $$U:=\bigcup\limits_{y\in Y}U_y,$$ $$Y_x:=\{y\in Y\mid x\in U_y\},$$ $$B:=\{x\in U\mid\inn(Y_x)\neq\emptyset\},$$ dann ist $B$ endlich.
	\end{lemma}
    \begin{proof}
    	TODO
    \end{proof}
